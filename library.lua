...
DustyRose = {
	...
	TextColor = Color3.fromRGB(255, 255, 255),      -- Teks: Putih (lebih cerah)
	
	-- PERBAIKAN 1: Background Utama JAUH lebih terang dan Pink
	Background = Color3.fromRGB(90, 75, 100),       -- Latar Belakang: Pink Muda Kebiruan (Lilac/Mauve)
	Topbar = Color3.fromRGB(110, 95, 120),          -- Topbar: Sedikit lebih terang
	Shadow = Color3.fromRGB(60, 50, 70),            -- Bayangan

	-- Notifikasi
	NotificationBackground = Color3.fromRGB(120, 105, 130),
	NotificationActionsBackground = Color3.fromRGB(150, 135, 160),

	-- Tab Menu
	TabBackground = Color3.fromRGB(130, 115, 140),          -- Latar Belakang Tab: Pink muda
	TabStroke = Color3.fromRGB(160, 145, 170),
	...
	ElementBackground = Color3.fromRGB(140, 125, 150),      -- Warna tombol/elemen: Pink muda/lilac
	ElementBackgroundHover = Color3.fromRGB(170, 155, 180), -- Sedikit terang saat di-hover
	SecondaryElementBackground = Color3.fromRGB(130, 115, 140), 
	ElementStroke = Color3.fromRGB(220, 40, 140),           -- Garis luar: Pink Tua Aksen
	SecondaryElementStroke = Color3.fromRGB(160, 145, 170),

	-- Slider
	SliderBackground = Color3.fromRGB(120, 105, 130),
	SliderProgress = Color3.fromRGB(240, 60, 160),          -- Progres Slider: Pink Tua yang lebih cerah
	SliderStroke = Color3.fromRGB(255, 80, 180),

	-- Toggle (On/Off)
	ToggleBackground = Color3.fromRGB(140, 125, 150),
	ToggleEnabled = Color3.fromRGB(220, 40, 140),           -- Aktif: Pink Tua Aksen
	ToggleDisabled = Color3.fromRGB(120, 105, 130),         -- Nonaktif: Pink sedang
	-- PERBAIKAN 2: Stroke toggle tetap Putih
	...
	ToggleDisabledOuterStroke = Color3.fromRGB(110, 95, 120),

	-- Dropdown
	DropdownSelected = Color3.fromRGB(150, 30, 90),         -- Pink Tua
	DropdownUnselected = Color3.fromRGB(130, 115, 140),     -- Pink muda

	-- Input Teks
	InputBackground = Color3.fromRGB(90, 75, 100),
	InputStroke = Color3.fromRGB(220, 40, 140),             -- Garis luar input: Pink Tua Aksen
	PlaceholderColor = Color3.fromRGB(180, 170, 190)
},
  
        Cyber = {
	-- Teks dan Latar Belakang Utama
	TextColor = Color3.fromRGB(0, 255, 180),  -- Teks Neon (Menggunakan TextColor Anda)

	Background = Color3.fromRGB(10, 10, 20), -- Latar Belakang Utama (Menggunakan mainFrame Anda)
	Topbar = Color3.fromRGB(0, 200, 160),    -- Bagian Atas Jendela (Menggunakan Top Anda)
	Shadow = Color3.fromRGB(5, 5, 15),       -- Bayangan gelap

	-- Notifikasi
	NotificationBackground = Color3.fromRGB(15, 15, 30), -- (Menggunakan NotifyFrame Anda)
	NotificationActionsBackground = Color3.fromRGB(20, 20, 40),

	-- Tab Menu
	TabBackground = Color3.fromRGB(20, 20, 35),           -- Latar Belakang Tab (Menggunakan TabContent Anda)
	TabStroke = Color3.fromRGB(30, 30, 50),
	TabBackgroundSelected = Color3.fromRGB(0, 220, 170),  -- Tab Terpilih (Menggunakan TabButtons Anda)
	TabTextColor = Color3.fromRGB(180, 180, 200),
	SelectedTabTextColor = Color3.fromRGB(255, 255, 255),

	-- Elemen Umum (Tombol, kotak, dll.)
	ElementBackground = Color3.fromRGB(25, 25, 45),
	ElementBackgroundHover = Color3.fromRGB(35, 35, 60), -- Sedikit lebih terang saat di-hover
	SecondaryElementBackground = Color3.fromRGB(15, 15, 30), 
	ElementStroke = Color3.fromRGB(0, 255, 180),         -- Aksen Neon untuk garis luar elemen
	SecondaryElementStroke = Color3.fromRGB(50, 50, 70),

	-- Slider (Menggunakan warna Buttons sebagai dasar aksi)
	SliderBackground = Color3.fromRGB(15, 15, 30),
	SliderProgress = Color3.fromRGB(0, 180, 140),        -- Progres slider (Menggunakan Buttons Anda)
	SliderStroke = Color3.fromRGB(0, 255, 180),

	-- Toggle (On/Off)
	ToggleBackground = Color3.fromRGB(25, 25, 45),
	ToggleEnabled = Color3.fromRGB(0, 255, 180),         -- Neon saat ON
	ToggleDisabled = Color3.fromRGB(50, 50, 70),         -- Abu-abu gelap saat OFF
	...
	-- Dropdown
	DropdownSelected = Color3.fromRGB(0, 180, 140),      -- Warna neon gelap saat dipilih
	DropdownUnselected = Color3.fromRGB(15, 15, 30),

	-- Input Teks
	InputBackground = Color3.fromRGB(10, 10, 20),
	InputStroke = Color3.fromRGB(0, 255, 180),           -- Garis luar neon
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('Rayfields') or game:GetObjects("rbxassetid://10804731440")[1]
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping ''.", Duration = 7, Image = 4400697855})
		else
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.ShowText then
		MPrompt.Title.Text = 'Menu '..Settings.Text
	end

	LoadingFrame.Version.TextTransparency = 1
	LoadingFrame.Title.Text = Settings.LoadingTitle or "ZHENSHUB"
